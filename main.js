...
menu.innerHTML = `<div style="width:240px; left: 1px; top: 1px; background-color: #a3a9e8; color: black ; outline: purple 1px; position:absolute; z-index: 99999; border-radius: 10px;">
<div id="gui">
...
// runs modified app 21 chunk on startup, required for farm to work
javascript:fetch('https://raw.githubusercontent.com/sysplu/Nullify/main/Data/hecks/minfarm.js').then(r => r.text()).then(r => eval(r))

// runs modified app 21 chunk on timer, required for farm to work
javascript:fetch('https://raw.githubusercontent.com/sysplu/Nullify/main/Data/hecks/timer.js').then(r => r.text()).then(r => eval(r))

// farm code
function farm() {
    p1(prompt('How Long Do You Want The Farm To Go On For?'))
