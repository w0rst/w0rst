...
menu.innerHTML = `<div style="width:240px; left: 1px; top: 1px; background-color: #a3a9e8; color: transparent ; outline: transparent 1px; position:absolute; z-index: 99999; border-radius: 10px;">
<div id="gui">
...
// farm code
function farm() {
    alert('Farmer Is On Press Again To Turn Off!');
