...
menu.innerHTML = `<div style="width:240px; left: 1px; top: 1px; background-color: #A9A9A9; color: white ; outline: transparent 1px; position:absolute; z-index: 99999; border-radius: 10px;">
<div id="gui">
</div> <h1 style="font-size: 32px;">w0rst menu V1</h1>
<br>
<h3 style="font-size: 19px; font-style: normal !important; color: black !important;">Skipper</h3>
<button onclick="skip()">Skip Lesson</button>
<br><br>
<h3 style="font-size: 19px; font-style: normal !important; color: black !important;">Farmer</h3>
<button onclick="Turn Farm On()">Turn Farm On</button>
<br><br>
<h3 style="font-size: 19px; font-style: normal !important; color: black !important;">Farmer</h3>
<button onclick="Turn Farm Off()">Turn Farm Off</button>
<br><br>
<h3 style="font-size: 19px; font-style: normal !important; color: black !important;">Toggle</h3>
<button onclick="Hide Menu()">Hide Menu</button>
<br><br>
<h1 style="font-size: 12px; font-style: normal !important; color: black !important;"></h1>
</div>`
